...
public class MealControllerTest {
    ...
    private static final float PRICE_15_99 = (float) 15.99;
    ...
    public void whenGetAllMeal_thenReturnMeal() throws Exception {
        ...
        Mockito.when(mealService.findAll()).thenReturn(mealList);
    ...
    public void whenGetMealById_thenReturnMeal() throws Exception {
        ...
        Mockito.when(mealService.findById(1L)).thenReturn(meal);
