...
import com.finartz.RestApp.controller.AddressController;
...
public class AddressControllerTest {
    ...
    public void whenGetAllAddress_thenReturnAddress() throws Exception {
        ...
        Mockito.when(addressService.findAll()).thenReturn(addressList);
    ...
    public void whenGetByAddressId_thenReturnAddress() throws Exception {
        ...
        Mockito.when(addressService.findById(1L)).thenReturn(address);
