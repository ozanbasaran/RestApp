...
import com.finartz.RestApp.controller.BasketController;
import com.finartz.RestApp.model.Basket;
import com.finartz.RestApp.model.BasketMeal;
...
public class BasketControllerTest {
    ...
    public void whenGetAllBasket_thenReturnBasket() throws Exception {
        ...
        Mockito.when(basketService.findAll()).thenReturn(basketList);
    ...
    public void whenGetByBasketId_thenReturnBasket() throws Exception {
        ...
        Mockito.when(basketService.findById(1L)).thenReturn(basket);
