...
import com.finartz.RestApp.controller.CountyController;
...
public class CountyControllerTest {
    ...
    public void whenGetAllCounty_thenReturnCounty() throws Exception {
        ...
        Mockito.when(countyService.findAll()).thenReturn(countyList);
    ...
    public void whenGetCountyById_thenReturnCounty() throws Exception {
        ...
        Mockito.when(countyService.findById(1L)).thenReturn(county);
